...
extern "C"
{
    ...
    extern void as_api_init();
    extern void as_api_deinit();
    extern void as_api_run();
    
    void as_api_do_set_servo(float servo_no, float pwm);
    void as_api_do_motor_test(float motor_no, float pwm);
    void as_api_do_set_mode(control_mode_t mode_);
    void as_api_request_param_list(void);
    void as_api_send_rc_channels_override(uint16_t ch1, uint16_t ch2, uint16_t ch3, uint16_t ch4,
